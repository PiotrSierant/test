...
import { PrivacySection } from "../src/components/_section/privacy/privacySection";
import { Footer } from '../src/components/_section/footer/footer';

const Privacy: NextPage = () => (
    <>
        <Head>
            <title>Zdrowy Sukces - polityka prywatności</title>
            <meta name="description" content="Zdrowy Sukces - polityka prywatności" />
            ...
            <meta property="og:title" content="Zdrowy Sukces - polityka prywatności" />
            <meta property="og:site_name" content="Zdrowy Sukces - polityka prywatności" />
            <meta property="og:type" content="website" />
            <meta property="og:url" content="https://zdrowy-sukces.pl/polityka-prywatnosci" />
            <meta property="og:description" content="Zdrowy Sukces - polityka prywatności" />
