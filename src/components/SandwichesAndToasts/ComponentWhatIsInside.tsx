...
export const ComponentWhatIsInside = () => {
    ...
    useEffect(() => {
        ...
        const thumbnails = importAll(
            require.context(
                "../../assets/images/sandwitchesPhoto/mini",
                false,
                /^\.\/.*$/,
                "lazy"
            )
    ...
    useEffect(() => {
        ...
        const imagesFull = importAll(
            require.context(
                "../../assets/images/sandwitchesPhoto/fhd",
                false,
                /^\.\/.*$/,
                "lazy"
            )
    ...
    return (
        <Layout id="whatInside" bg={styles.whatinside}>
            <h2 data-aos="fade-up">Zobacz jak e-book wygląda w środku</h2>
