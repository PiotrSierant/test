            ...
            {isOpen && (
                ...
                >
                    ...
                    {editor.getAttributes("link").href ? (
                        ...
                        <button type="button" className="novel-flex novel-items-center novel-rounded-sm novel-p-1 novel-text-stone-600 novel-transition-all hover:novel-bg-stone-100">
                            <Check className="novel-h-4 novel-w-4" onClick={() => {
                                setIsOpen(false);
                            }} />
                        </button>
                    )}
