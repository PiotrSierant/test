...
export const ComponentWhatIsInsideWomen = () => {
    ...
    useEffect(() => {
        ...
        const thumbnails = importAll(
            require.context(
                "../../assets/images/dlaPlodnosci/women/mini",
                false,
                /^\.\/.*$/,
                "lazy"
            )
    ...
    useEffect(() => {
        ...
        const imagesFull = importAll(
            require.context(
                "../../assets/images/dlaPlodnosci/women/fhd",
                false,
                /^\.\/.*$/,
                "lazy"
            )
    ...
    return (
        <Layout id="whatInside" bg={styles.whatinside}>
            <h2 data-aos="fade-up">Zobacz dietę i kompendium w niepłodności kobiet</h2>
